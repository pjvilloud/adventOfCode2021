...
public class Day03 {
    ...
    public static void calculateSubmarineConsumption(String commands){
        ...
        for(int i = 0; i < lines[0].length(); i++){
            int finalI = i;
            long nbOfZeroes = Arrays.stream(lines).filter(s -> s.charAt(finalI) == '0').count();
            long nbOfOnes = Arrays.stream(lines).filter(s -> s.charAt(finalI) == '1').count();
            gammaRate.append(nbOfZeroes > nbOfOnes ? '0' : '1');
